const txtInput = document.querySelector("#txtInput");
  ...
  { name: "du pg", url: "http://127.0.0.1:8000/Universities/DUpost/" },
  { name: "du ug", url: "http://127.0.0.1:8000/Universities/DUunder/" },
  ...
  { name: "hyderabad university", url: "http://127.0.0.1:8000/Universities/University-Of-Hyderabad/" },
      ...
      //   if(userInput.toLowerCase().includes('univer')||userInput.toLowerCase().includes('coll')||userInput.toLowerCase().includes('list')){
      //     unisByText();
      //     return 'Loading Universties...';
      //   }
      ...
      //   } else if (userInput.toLowerCase().includes(responseObj.keys())) {
      //     return responseObj[userInput];
      //   } else if (dateRegex.test(userInput)) {
      ...
      const getChatbotResponse = (userInput, responseObj) => {
        ...
        else if(userInput.toLowerCase().replace(/\s+/g, '').includes("bye")){
          return responseObj[userInput];
        }
        else if(userInput.toLowerCase().replace(/\s+/g, '').includes("ye")||userInput.toLowerCase().replace(/\s+/g, '').includes("sure")||userInput.toLowerCase().replace(/\s+/g, '').includes("ido")||userInput.toLowerCase().replace(/\s+/g, '').includes("something")){
